var Page = {
    initMultiple: function () {
        // Multiple lines
        var data1 = [[0, 10], [1, 8], [2, 6], [3, 7], [4, 4], [5, 15], [6, 10], [7, 8], [8, 6], [9, 13], [10, 10]];
        var data2 = [[0, 7], [1, 10], [2, 5], [3, 3], [4, 13], [5, 10], [6, 14], [7, 12], [8, 8], [9, 11], [10, 8]];
        var labels = ["Visits", "Pages"];
        var colors = ['#ddd', '#41D492'];
        var borderColor = '#f9f9f9';
        var bgColor = '#fff';
        var selector = '#multiple-chart';
    ...
    initDonut: function () {
        ...
        // Donut chart
        var labels = ["Series 1", "Series 2", "Series 3", "Series 4"];
        var datas = [30, 25, 5, 15];
        var colors = ['#28BB79', '#41D492', '#5BEEAC', "#74FFC5"];
    ...
    initPie: function () {
        // Pie chart
        var labels = ["Series 1", "Series 2", "Series 3"];
        var datas = [20, 35, 10];
        var colors = ['#41D492', '#5BEEAC', "#74FFC5"];
    ...
    initCombined: function () {
        ...
        var labels = ["Last 24 Hours", "Last 48 Hours", "Difference"];
        var datas = [data24Hours, data48Hours, dataDifference];
        var selector = '#combined-chart';
