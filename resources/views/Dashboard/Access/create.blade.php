        ...
        <div class="col-md-12">
            <div class="card card-default widget">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('dashboard.access.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control text-right" style="direction: rtl" name="user_id" id="user_id">
                                        @if(old('user_id'))
                                            <option value="{{ \App\User::find(old('user_id'))->id }}" selected>
                                                {{ \App\User::find(old('user_id'))->fullName }}
                                            </option>
                                        @endif
                                    </select>
                                    <script>
                            ...
                            <script>
                                $('#expired_at').MdPersianDateTimePicker({
                                    ...
                                    toDate: false,
                                    placement: 'top',
                                    selectedDate: new Date('{{ $expired_at }}'),
