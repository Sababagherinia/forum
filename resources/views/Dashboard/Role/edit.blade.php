        ...
        <div class="col-md-12">
            <div class="card card-default widget">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('dashboard.role.update' , ["id" => $role->id]) }}">
                        {{ method_field("PATCH") }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('title' , $role->title) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="{{ old('label', $role->label) }}"
                                           name="label" id="label" placeholder="لیبل">
                                </div>
                            </div>
